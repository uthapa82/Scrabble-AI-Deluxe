...
public class Board {
	...
	private IArray<Array<Space>> board = new Array<Array<Space>>(15); //CHANGED
	...
	public BufferedImage getTileImage(int row, int col) { //NEW
		return board.get(row).get(col).getTile().getImage();
	}
	public void drawBoard(Graphics2D g2d) { //NEW
